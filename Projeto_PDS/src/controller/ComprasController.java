...
public class ComprasController {
	...
	public  ComprasController(TelaCompras telaCompras, ProdutoDAO produtoDAO, Navegador navegador, java.util.List<Produto> carrinho, TelaFinalizarCompra telaFinalizarCompra) {
		super();
	...
	private void finalizarCompra() {
		...
		if(carrinho.isEmpty()) {
			...
			int confirm = JOptionPane.showConfirmDialog(null, "Deseja finalizar sua compra", "Confirmação", JOptionPane.YES_NO_OPTION);
